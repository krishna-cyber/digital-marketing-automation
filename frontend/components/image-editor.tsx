...
import { History, Loader2, Undo, Wand2 } from "lucide-react"
...
Describe the edited image in one detailed sentence (max 30 words):`,
      ...
      setHistory((prev) => [
        ...prev,
        { instruction: edit, description: currentDescription },
      ])
  ...
  return (
    <div className="mx-auto w-full max-w-xl space-y-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="mb-3 flex aspect-video items-center justify-center rounded-lg bg-gradient-to-br from-amber-50 to-orange-100 dark:from-amber-900 dark:to-orange-900">
      ...
      <p className="text-center text-xs text-muted-foreground">
        In production, this would use image editing APIs (like DALL-E edit) to
